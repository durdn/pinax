...
# ubuntu gradient
write_png("bg-ustyle.png", 1, 800, gradient([
    (0.75, (0x79, 0x66, 0x46), (0xD3, 0xCA, 0xAA)),
    (1.0,  (0xD3, 0xCA, 0xAA), (0xD3, 0xCA, 0xAA)),
]))

write_png("bg-ustyle-test.png", 80, 600, gradient([
    (0.65, (0x79, 0x66, 0x46), (0xD3, 0xCA, 0xAA)),
    (1.0,  (0xD3, 0xCA, 0xAA), (0xD3, 0xCA, 0xAA)),
]))
